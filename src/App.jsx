...
export default function App() {
  ...
  return <div style={styles.page}><style>{HOVER_STYLES}</style>
    <header style={styles.hero}>
      ...
      <h1 style={styles.heroTitle}>Make better money decisions.</h1>
      <p style={styles.heroSub}>{toolsData.length} free tools for the questions that come up in real life.</p>
