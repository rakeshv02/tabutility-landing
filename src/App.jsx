    ...
    <div style={styles.hero}>
      <div className="hero-split" style={styles.heroSplit}>
        ...
        <div style={styles.heroLeft}>
          ...
          <p style={styles.heroSub}>Salary, tax, mortgage and loan calculators with transparent assumptions and instant results.</p>
